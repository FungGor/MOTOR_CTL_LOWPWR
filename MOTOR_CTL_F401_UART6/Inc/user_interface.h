...
/* Exported types ------------------------------------------------------------*/
/**
 * @brief Motor control System Level Configuration and Control
 *
 * Enumerates the variables and information that can be exchanged across the Motor Control Protocol (Extension)
 */
typedef enum
{
	MC_PROTOCOL_SYS_SLEEP,             /*0*/
	MC_PROTOCOL_SYS_WAKEUP,            /*1*/
	MC_PROTOCOL_SYS_HEARTBEAT,         /*2*/
	MC_PROTOCOL_SYS_FW,                /*3*/
	MC_PROTOCOL_SYS_TAIL_LIGHT_ON,     /*4*/
	MC_PROTOCOL_SYS_TAIL_LIGHT_OFF,    /*5*/
	MC_PROTOCOL_SYS_TAIL_LIGHT_TOGGLE  /*6*/
}MC_Protocol_SYS_t;
